...
class AddSlabDialog(QDialog, SlabDialog):
    ...
    def viewSlab(self):
        ...
        try:
            ...
            self.ViewWin.view_model_pyvista(self.nodeX, self.nodeY, self.nodeZ, self.model_out)
            self.ViewWin.show()
            # try expect KeyError
...
class AddRandomEllipsoidDialog(QDialog, RandomEllipsoidDialog):
    ...
    def viewEllipsoid(self):
        ...
        if random_ellipsoid_view_win.select_flag:
            ...
            self.showWin.view_model_pyvista(self.nodeX, self.nodeY, self.nodeZ, model_in)
            self.showWin.show()
